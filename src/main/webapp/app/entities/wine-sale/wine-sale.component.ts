...
@Component({
  selector: 'jhi-wine-sale',
  templateUrl: './wine-sale.component.html',
})
export class WineSaleComponent implements OnInit, OnDestroy {
  wineSales?: IWineSale[];
  ...
  delete(wineSale: IWineSale): void {
    const modalRef = this.modalService.open(WineSaleDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.wineSale = wineSale;
  }
