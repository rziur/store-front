...
@Component({
  selector: 'jhi-wine-offer',
  templateUrl: './wine-offer.component.html',
})
export class WineOfferComponent implements OnInit, OnDestroy {
  ...
  delete(wineOffer: IWineOffer): void {
    const modalRef = this.modalService.open(WineOfferDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.wineOffer = wineOffer;
  }
